...
**Neue Meilensteine (v3.4):** M63 (Planning-Tab + Notifications) · M64 (Server-Wizard) · M65 (Webapp-Parität + Auto-Re-Publish) · M66 (Desktop-Settings + Link-Opener) — abgeschlossen.
